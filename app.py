...
# Replace all model loading with:
# model_path = os.path.join(BASE_DIR, 'models', 'RandomForest.pkl')
# model = joblib.load(model_path)
model_path_crop = os.path.join(BASE_DIR, 'ensemble_model.pkl')
model_path_yield = os.path.join(BASE_DIR, 'xgboost_model.pkl')

# Load your trained ML models
# crop_model = joblib.load('ensemble_model.pkl')
# yield_model = joblib.load('xgboost_model.pkl')
crop_model = joblib.load(model_path_crop)
yield_model = joblib.load(model_path_yield)
